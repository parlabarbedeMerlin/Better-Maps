...
const TextFiled = ({ label, placeholder, id, name, error, touched, className, ...props }) => (
  <div className="w-full">
    ...
    <input className={clsx("rounded-xl border-2 border-neutral-300 outline outline-0  focus:border-green-300 focus:outline-4 outline-offset-0 focus:outline-offset-2 outline-green-300  h-10 w-full p-2 my-1 outline-none transition-all duration-500",
      {
